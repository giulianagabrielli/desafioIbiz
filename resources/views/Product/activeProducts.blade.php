...
<section class="container">
    <div class="row">
        <div class="col-md-12 mb-4">
            ...
            <a href="/produtos/ativos" class="btn btn-success">Ativos</a>
            <a href="/produtos/inativos" class="btn btn-outline-secondary">Inativos</a>
        </div>
        ...
        <div class="col-md-12">
            <table class="table">
                ...
                @empty
                    <h1>Não há produtos ativos cadastrados</h1>
                @endforelse   
                </tbody>
            </table>
        </div>
